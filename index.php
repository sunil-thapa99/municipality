				...
				<form class="form" method="POST" action="display.php">
						...
						<div class="form-row">
							...
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
								<div class="form-group">
										...
										<input type="text" class="form-control input-md" placeholder="mm/dd/yyyy" required="" name="dobBS">
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="col-xs-12 col-sm-6 col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control input-md" placeholder="Citizenship Date of Issue" required="" name="citizenshipIssueDate">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-4">
								<div class="form-group">
					...
					<fieldset>
						...
						<div class="form-row">
		                    ...
		                    <div class="col-xs-12 col-sm-6 col-md-4">
		                        <div class="form-group">
		                            <label>Phone Number</label>
		                            <input type="number" class="form-control input-md" placeholder="Phone Number" maxlength="10" name="motherOccupation">
		                        </div>
		                    </div>
		                    <div class="col-xs-12 col-sm-6 col-md-4">
		                        <div class="form-group">
					...
					<div class="row">
						...
						<div class="file-upload col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<div class="text-center">
								<button class="center-block" type="button" id="snap" onclick="start()">Start & Capture</button>
							</div>
						</div>	
